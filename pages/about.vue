...
<template>
  <div class="py-5">
    <div class="sm:grid grid-cols-8 px-4 py-5 sm:py-9 gap-5 container max-w-5xl mx-auto">
      <div class="col-span-5 max-w-md">
        <div class="flex justify-between">
          ...
          <div class="sm:hidden block col-span-3 pb-5 dark:text-[#F1F2F4]">
            <NuxtImg src="/bulat.jpg" width="125" height="125" quality="50" class="rounded-md" />
          </div>
        </div>
      ...
      <div class="hidden sm:block col-span-3">
        <NuxtImg src="/bulat.jpg" width="500" height="500" quality="50" class="rounded-md" />
      </div>
    </div>
  </div>
</template>
